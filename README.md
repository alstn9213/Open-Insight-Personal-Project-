...
1.  **데이터 수집/가공 (Python):** 공공데이터포털을 통해 상권/매출/폐업 데이터를 수집하고 정제하여 MariaDB에 적재.
...
1.  **Swagger 활용:** Spring Boot를 사용 중이므로 `springdoc-openapi-starter-webmvc-ui` 의존성을 추가하여 이 명세서를 자동으로 시각화한 화면을 캡처
